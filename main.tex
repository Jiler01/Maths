...
Remerciements spéciaux à Mme Leclerc, Mme Escot, feu M Colin, M Tierno et Mme Beltzung pour leurs connaissances, soutiens et passions, ainsi qu'a Yvan Monka (\href{https://www.maths-et-tiques.fr/}{Maths et tiques}) et Grant Sanderson (\href{https://www.3blue1brown.com}{3Blue1Brown}).\\
\break
\underline{Notation:}\\
...
\begin{itemize}
	\item On note $x^k$ ($x\in\mathbb{R^{+*}}$) tel que $\exp(n\ln(x))$
	\item On note $\sqrt[k]{x} = x^\frac{1}{n}$
...
\section{Vecteurs}
\href{https://youtu.be/fNk_zzaMoSs}{\underline{Vidéo (anglais)}}\\
\break
Propriétés:
\begin{enumerate}
...
\href{https://youtu.be/LyGKycYT2v0}{\underline{Compréhension la dualité entre le produit scalaire et les produits de matrices (anglais)}}\\
\break
...
\section{Plan}
\href{https://youtu.be/k7RM-ot2NWY}{\underline{Vidéo (anglais}}\\
\break
...
\section{Matrices}
\href{https://youtu.be/kYB8IZa5AuEl}{\underline{Vidéo (anglais)}}\\
\break
\begin{enumerate}
...
\href{https://youtu.be/Ip3X9LOh2dk}{\underline{Vidéo (anglais)}}\\
\href{https://youtu.be/v8VSDg_WQlA}{\underline{Compréhension des matrices non carrées et de pourquoi elles n'ont pas de déterminant (anglais)}}\\
\break
...
\href{https://youtu.be/XkY2DOUCWMU}{\underline{Vidéo (anglais)}}\\
\break
\begin{enumerate}
...
\href{https://youtu.be/PFDu9oVAE-g}{\underline{Vidéo sur les vecteurs et valeurs propres (anglais)}}\\
\break
...
\end{impl}
\break
\href{https://youtu.be/e50Bj7jn9IQ}{\underline{Vidéo d'une technique de calcul rapide des valeurs propres (anglais)}}
...
\break
\href{https://youtu.be/jBsC34PxzoM}{\underline{Vidéo sur une méthode alternative, méthode de Cramer (anglais)}}
