...
$$\mathcal{P_BA} = \frac{\mathcal{P_AB} \times \mathcal{PA}}{\mathcal{PA}}$$
...
\underline{Théorèmes:}
\begin{enumerate}
	\item Soit $n\in\mathbb{Z}, a\in\mathbb{C}$, il existe un polynôme $Q$ de degré $n-1$ tel que $z^n-a^n = (z-a)Q(z)$.
